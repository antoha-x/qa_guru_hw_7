...
def test_working_qa(open_csv_file_in_archive: list):
...
def test_working_devops_in_honolulu(open_pdf_file_in_archive: list):
...
def test_working_hr(open_xlsx_file_in_archive: list):
